                                    ...
                                    <v-card-item class="row justify-conten-between align-items-center">
                                        <div class="col-md-10">
                                            ...
                                            <a class="subtitulo_card justify-content-start pl-0" href="">
                                                <p>Micheline Barroso e Lívia Vasconcelos | Fundadoras @ Inova-te</p>
                                            </a>
                                        </div>
                                        <div class="col-md-2">
                        ...
                        <div class="mt-4" style="padding-top: 8px; padding-bottom: 8px; background-color: white; border-radius: 8px">
                            <div class="" style="padding: 16px;">
                                ...
                                <!-- <p class="subtitulo_ativ ml-2">
                                    ...
                                    v-model="checkbox"
                                    :value="true"
                                    label="Declaro que estou ciente da atividade que escolhi."
                                    ></v-checkbox>
                                    {{ validar() }}
...
import router from '../router/router'
  export default {
    ...
    methods:{
        ...
        async inscrever(){
            await db.collection("workshop2").get().then((querySnapshot) => {
